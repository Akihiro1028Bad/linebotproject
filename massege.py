...
✅ Googleカレンダーへの予定追加
✅ その日の予定のチェック\n
さらに、毎朝6時にはその日の予定をお知らせします。\n
日々のスケジュール管理を、よりスムーズに、より楽しくサポートさせていただきます！\n
どうぞよろしくお願い申し上げます😊''')
    ...
    bubble_2 = BubbleContainer(
        body=BoxComponent(
            ...
            contents=[
                ...
                # 説明文のテキストコンポーネント
                TextComponent(text="よりスマートに。", size="md", wrap=True),
